...
class TestParagraphSizer(unittest.TestCase):
    ...
    def test_count_lines_courier14(self):
        paragraph = self._document.add_paragraph(style="Code")
        paragraph.add_run("01-01 12:00:31.238  3642  3659 I ActivityManager: Start proc 4414:com.google.android.deskclock/u0a13 for broadcast com.google.android.deskclock/com.android.deskclock.AlarmInitReceiver")
        ps = ParagraphSizer(paragraph, None, self._max_width - LISTING_OFFSET)
